    ...
    <div id="viewAdmin" style="display: none;">
      ...
      <div id="adminTabStudents" class="card">
        ...
        <div class="table-container">
          <table>
            <thead>
              <tr><th>Roll No</th><th>Register No</th><th>Student Name</th><th>Section</th><th>Attendance %</th><th>Action</th></tr>
            </thead>
  ...
  <script>
    ...
    function renderAdminStudents() {
      ...
      tbody.innerHTML = list.map((s, idx) => {
        ...
        const isShortage = parseFloat(pctNum) < 75.0;
        ...
        return \`
          <tr>
            ...
            <td>
              <span class=\"badge \${isShortage ? 'badge-danger' : 'badge-success'}\">
                \${pctNum}% \${isShortage ? '⚠️ Shortage' : '✓ Good'}
              </span>
              <div style=\"font-size: 0.72rem; color: var(--muted); margin-top: 2px;\">\${presentCount} of \${totalCount} attended</div>
            </td>
